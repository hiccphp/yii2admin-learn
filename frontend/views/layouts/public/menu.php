...
<ul class="nav navbar-nav">
    ...
    <li class="menu-dropdown classic-menu-dropdown ">
        ...
        <ul class="dropdown-menu pull-left">
            ...
            <li class=" ">
                <a href="<?=Url::to('/test/i18n')?>" class="nav-link ">
                    <i class="icon-graph"></i> 国际化
                    <span class="badge badge-danger">0</span>
                </a>
            </li>
                ...
                <div class="mega-menu-content">
                    <div class="row">
                        <div class="col-md-4">
                            <ul class="mega-menu-submenu">
                                <li>
                                    <a href="/learn/widget"> 小组件 </a>
                                </li>
                                <li>
                                    <a href="/event/index"> 事件机制 </a>
                                </li>
                                <li>
                                    <a href="/event/mixi"> mixi混合行为 </a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-4">
