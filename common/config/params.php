...
//        'url' => Yii::$app->params['STORAGE_URL'] . '/web/',
    ...
    'ueditorConfig' => [
        /* 图片上传配置 */
        'imageRoot' => Yii::getAlias("@storage/web/image"), //图片path前缀
//        'imageRoot'            => Yii::getAlias("@base/web/storage"), //图片path前缀，服务器解析到/web/目录时，上传到这里
        ...
        /* 文件上传配置 */
        'fileRoot' => Yii::getAlias("@storage/web/file"), //文件path前缀
//        'fileRoot'             => Yii::getAlias("@base/web/storage"), //文件path前缀，服务器解析到/web/目录时，上传到这里
        ...
        /* 上传视频配置 */
        'videoRoot' => Yii::getAlias("@storage/web/video"),
//        'videoRoot'            => Yii::getAlias("@base/web/storage"), // 服务器解析到/web/目录时，上传到这里
        ...
        /* 涂鸦图片上传配置项 */
        'scrawlRoot' => Yii::getAlias("@storage/web/doodle"),
