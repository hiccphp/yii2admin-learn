...
<div class="fileinput fileinput-new" data-provides="fileinput">
    ...
    <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
        <img class="file_img"
             src="<?= !empty($picture['path']) ? $previewUrl . $picture['path'] : \yii\helpers\Url::to('@web/static/images/no.png'); ?>">
    </div>
</div>
...
file_img.attr('src','<?= $previewUrl . Yii::$app->params['upload']['url'] ?>'+json.data.url);
