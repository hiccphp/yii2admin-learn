...
<?= $form->field($model, 'cms_model_id')->selectList(
    ArrayHelper::merge(['0' => '默认模型'], ArrayHelper::map(\backend\models\CmsModel::find()->asArray()->all(), 'id', 'name')),
    ['class' => 'form-control c-md-2'])->label('上级模型') ?>
